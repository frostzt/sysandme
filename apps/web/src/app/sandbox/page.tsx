      ...
      {hasVoiceSupport ? (
        <>
          ...
          <div className="p-6 flex flex-col items-center space-y-4 border-b border-gray-200">
            ...
            <div className="text-center">
              {error && (
                <div className="mb-2 p-2 bg-red-100 text-red-700 text-xs rounded-md max-w-48">
                  <p>⚠️ {error}</p>
                </div>
              )}
              {isListening && (
          ...
          <div className="p-4 border-t border-gray-200 bg-gray-50">
            <div className="text-xs text-gray-600 space-y-1">
              ...
              <p className="mt-2 text-yellow-600">⚠️ <strong>Troubleshooting:</strong></p>
              <p>• Allow microphone permissions when prompted</p>
              <p>• Check your internet connection for voice services</p>
        ...
        <div className="flex items-center space-x-4">
          ...
          >
            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
              <title>Voice Assistant Toggle</title>
              <path fillRule="evenodd" d="M7 4a3 3 0 0 1 6 0v4a3 3 0 1 1-6 0V4zm4 10.93A7.001 7.001 0 0 0 17 8a1 1 0 1 0-2 0A5 5 0 0 1 5 8a1 1 0 0 0-2 0 7.001 7.001 0 0 0 6 6.93V17H6a1 1 0 1 0 0 2h8a1 1 0 1 0 0-2h-3v-2.07z" clipRule="evenodd" />
            </svg>
